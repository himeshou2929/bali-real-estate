...
<div class="max-w-4xl mx-auto">
    ...
    <form method="POST" action="{{ route('admin.properties.store') }}" enctype="multipart/form-data" class="bg-white shadow-md rounded-lg p-6">
        @csrf
            ...
            if (file.type.startsWith('image/')) {
                ...
                reader.onload = function(e) {
                    ...
                    div.innerHTML = `
                        ...
                        <span class="absolute top-1 right-1 bg-black bg-opacity-50 text-white text-xs px-1 rounded">${index + 1}</span>
                    `;
